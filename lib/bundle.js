...
document.addEventListener("DOMContentLoaded", () => {
  ...
  button.addEventListener('click', (e) => {
    e.preventDefault();
    let ga = new __WEBPACK_IMPORTED_MODULE_0__genetic_algorithm_sketch_js__["a" /* default */](destinations);
    ga.setup();
    getDuration();
    console.log(ga);
  });
...
class GeneticAlgorithm {
  ...
  setup() {
    this.population = new __WEBPACK_IMPORTED_MODULE_0__population_js__["a" /* default */](this.destinations, 3);
  }
